...
import com.hmx.ide.lsp.util.DocumentationReferenceProvider
import com.hmx.ide.progress.ProgressManager
import com.hmx.ide.utils.KeyboardUtils
  ...
  override fun setLayout(layout: CompletionLayout) {
    ...
    (layout.completionList as? ListView)?.let {
      ...
      it.setOnItemLongClickListener { _, view, position, _ ->
        val data =
          (items[position] as? com.hmx.ide.lsp.models.CompletionItem)?.data
