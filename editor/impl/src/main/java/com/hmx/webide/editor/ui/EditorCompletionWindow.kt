...
import com.hmx.webide.lsp.util.DocumentationReferenceProvider
import com.hmx.webide.progress.ProgressManager
import com.hmx.webide.utils.KeyboardUtils
  ...
  override fun setLayout(layout: CompletionLayout) {
    ...
    (layout.completionList as? ListView)?.let {
      ...
      it.setOnItemLongClickListener { _, view, position, _ ->
        val data =
          (items[position] as? com.hmx.webide.lsp.models.CompletionItem)?.data
