...
import com.hmx.webide.actions.EditorActionItem
import com.hmx.webide.actions.FillMenuParams
import com.hmx.webide.editor.R.layout
import com.hmx.webide.editor.databinding.LayoutPopupMenuItemBinding
import com.hmx.webide.editor.ui.EditorActionsMenu.ActionsListAdapter.VH
...
open class EditorActionsMenu(val editor: IDEEditor) :
  ...
  protected open fun onCreateActionData(): ActionData {
    ...
    data.put(com.hmx.webide.models.Range::class.java, editor.cursorLSPRange)
    return data
  }
