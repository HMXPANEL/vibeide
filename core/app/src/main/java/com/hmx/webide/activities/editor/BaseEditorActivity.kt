...
import com.hmx.webide.adapters.DiagnosticsAdapter
import com.hmx.webide.adapters.SearchListAdapter
import com.hmx.webide.app.EdgeToEdgeIDEActivity
import com.hmx.webide.databinding.ActivityEditorBinding
import com.hmx.webide.databinding.ContentEditorBinding
import com.hmx.webide.databinding.LayoutDiagnosticInfoBinding
import com.hmx.webide.fragments.SearchResultFragment
import com.hmx.webide.fragments.sidebar.EditorSidebarFragment
import com.hmx.webide.fragments.sidebar.FileTreeFragment
import com.hmx.webide.handlers.EditorActivityLifecyclerObserver
import com.hmx.webide.interfaces.DiagnosticClickListener
import com.hmx.webide.lookup.Lookup
import com.hmx.webide.lsp.models.DiagnosticItem
import com.hmx.webide.models.DiagnosticGroup
import com.hmx.webide.models.OpenedFile
import com.hmx.webide.models.Range
import com.hmx.webide.models.SearchResult
import com.hmx.webide.projects.IProjectManager
import com.hmx.webide.tasks.cancelIfActive
import com.hmx.webide.ui.CodeEditorView
import com.hmx.webide.ui.ContentTranslatingDrawerLayout
import com.hmx.webide.ui.SwipeRevealLayout
import com.hmx.webide.utils.ActionMenuUtils.createMenu
import com.hmx.webide.utils.DialogUtils.newMaterialDialogBuilder
import com.hmx.webide.utils.IntentUtils
import com.hmx.webide.utils.MemoryUsageWatcher
import com.hmx.webide.utils.flashError
import com.hmx.webide.utils.resolveAttr
import com.hmx.webide.viewmodel.EditorViewModel
  ...
  override fun onCreate(savedInstanceState: Bundle?) {
    ...
    if (savedInstanceState != null && savedInstanceState.containsKey(KEY_PROJECT_PATH)) {
      ...
      editorActivityScope.launch(Dispatchers.IO) {
        com.hmx.webide.knowledge.KnowledgeEngineImpl.refresh(File(projectPath))
      }
    }
