...
import com.hmx.webide.activities.editor.BaseEditorActivity
import com.hmx.webide.app.BaseApplication
import com.hmx.webide.editor.api.IEditor
import com.hmx.webide.editor.databinding.LayoutCodeEditorBinding
import com.hmx.webide.editor.ui.EditorSearchLayout
import com.hmx.webide.editor.ui.IDEEditor
import com.hmx.webide.editor.ui.IDEEditor.Companion.createInputTypeFlags
import com.hmx.webide.editor.utils.ContentReadWrite.readContent
import com.hmx.webide.editor.utils.ContentReadWrite.writeTo
...
import com.hmx.webide.utils.customOrJBMono
...
class CodeEditorView(
  ...
  private fun createLanguageServer(file: File): ILanguageServer? {
    ...
    // No built-in language servers for web files yet. VibeIDE will plug an AI web
    // language server here in a later checkpoint.
    return null
  }
