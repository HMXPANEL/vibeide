...
object PromptBuilder {
  ...
  fun build(index: ProjectIndex, currentFile: String? = null): String {
    ...
    sb.appendLine("You have file-operation tools. To create, overwrite, read, list, or delete project files,")
    sb.appendLine("call the appropriate tool with a RELATIVE path (e.g. index.html, src/style.css).")
    sb.appendLine("Do NOT embed file contents in your chat reply and do NOT use any special text markers;")
    sb.appendLine("the application writes the files for you through the tools.")
