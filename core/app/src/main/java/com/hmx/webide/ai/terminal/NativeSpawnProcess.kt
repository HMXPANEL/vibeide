...
/**
 * Kotlin wrapper around the native pocketspawn library.
 *
 * Ported from Mobile-Harness (https://github.com/techjarves/Mobile-Harness)
 * Original: app/src/main/java/com/jarves/mh/runtime/NativeSpawnProcess.kt
 *
 * This class provides a Process-compatible interface for executing commands
 * inside the PRoot environment via the native JNI bridge.
 */
internal class NativeSpawnProcess private constructor(
    ...
    companion object {
        /**
         * Start a new process via the native pocketspawn bridge.
         *
         * @param argv Command and arguments to execute
         * @param environment Environment variables as "KEY=VALUE" strings
         * @param cwd Working directory for the process
         * @param outputFile File to capture stdout/stderr
         * @return NativeSpawnProcess instance
         */
