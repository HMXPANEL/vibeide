...
package com.hmx.ide.lsp.internal.model
...
private constructor(
  ...
  val result: com.hmx.ide.lsp.models.CompletionResult
) {
  ...
  companion object {
    ...
    val EMPTY =
      cache(
        CompletionParams(
          com.hmx.ide.models.Position.NONE,
          Paths.get(""), ICancelChecker.CANCELLED
        ),
        com.hmx.ide.lsp.models.CompletionResult.EMPTY
      )
    ...
    fun cache(
      ...
      result: com.hmx.ide.lsp.models.CompletionResult
    ): CachedCompletion {
      val params =
