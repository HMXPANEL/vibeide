...
package com.hmx.webide.lsp.internal.model
...
private constructor(
  ...
  val result: com.hmx.webide.lsp.models.CompletionResult
) {
  ...
  companion object {
    ...
    val EMPTY =
      cache(
        CompletionParams(
          com.hmx.webide.models.Position.NONE,
          Paths.get(""), ICancelChecker.CANCELLED
        ),
        com.hmx.webide.lsp.models.CompletionResult.EMPTY
      )
    ...
    fun cache(
      ...
      result: com.hmx.webide.lsp.models.CompletionResult
    ): CachedCompletion {
      val params =
