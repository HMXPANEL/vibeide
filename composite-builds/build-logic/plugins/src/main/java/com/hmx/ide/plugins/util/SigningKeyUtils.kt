...
package com.hmx.ide.plugins.util

import com.hmx.ide.build.config.AUTH_PASS
import com.hmx.ide.build.config.AUTH_USER
import com.hmx.ide.build.config.KEY_BIN
import com.hmx.ide.build.config.KEY_URL
