package com.hmx.ide.desugaring.parsing

import com.google.common.truth.Truth.assertThat
import com.hmx.ide.desugaring.dsl.MethodOpcode
import com.hmx.ide.desugaring.internal.parsing.InsnLexer
import com.hmx.ide.desugaring.internal.parsing.InsnParser
import com.hmx.ide.desugaring.internal.parsing.InsnParser.ParseException
...
class InsnParserTest {
  ...
  fun `test basic types`() {
    ...
    invoke-virtual Ljava/lang/String;->length()I
      =>
    invoke-static Lcom/hmx/ide/desugaring/sample/java/lang/DesugaredString;->length(Ljava/lang/String;)I
      ;;
  """.trimIndent()
    ...
    invoke-virtual Ljava/lang/String;->charAt(I)C
      =>
    invoke-static Lcom/hmx/ide/desugaring/sample/java/lang/DesugaredString;->charAt(Ljava/lang/String;I)C
      ;;
  """.trimIndent()
  ...
  fun `test reference types`() {
    ...
    invoke-virtual Ljava/lang/Object;->clone()Ljava/lang/Object;
      =>
    invoke-static Lcom/hmx/ide/desugaring/sample/java/lang/DesugaredObject;->clone(Ljava/lang/Object;)Ljava/lang/Object;
      ;;
  """.trimIndent()
    ...
    invoke-virtual Ljava/lang/String;->concat(Ljava/lang/String;)Ljava/lang/String;
      =>
    invoke-static Lcom/hmx/ide/desugaring/sample/java/lang/DesugaredString;->concat(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
      ;;
  """.trimIndent()
  ...
  fun `test single-dimensional arrays`() {
    ...
    invoke-virtual Ljava/lang/String;->someArr()[I
      =>
    invoke-static Lcom/hmx/ide/desugaring/sample/java/lang/DesugaredArrays;->someArr([I)I
      ;;
  """.trimIndent()
    ...
    invoke-static Ljava/util/Arrays;->sort([I)V
      =>
    invoke-static Lcom/hmx/ide/desugaring/sample/java/util/DesugaredArrays;->sort([I)V
      ;;
  """.trimIndent()
  ...
  fun `test multi-dimensional arrays`() {
    ...
    invoke-virtual Ljava/lang/String;->length()I
      =>
    invoke-static Lcom/hmx/ide/desugaring/sample/java/lang/DesugaredArrays;->length([[I)I
      ;;
  """.trimIndent()
    ...
    invoke-static Ljava/util/Arrays;->deepEquals([[I)V
      =>
    invoke-static Lcom/hmx/ide/desugaring/sample/java/util/DesugaredArrays;->deepEquals([[I)V
      ;;
  """.trimIndent()
  ...
  fun `test array of reference types`() {
    ...
    invoke-virtual Ljava/lang/String;->clone()Ljava/lang/Object;
      =>
    invoke-static Lcom/hmx/ide/desugaring/sample/java/lang/DesugaredObject;->clone([Ljava/lang/String;)Ljava/lang/Object;
      ;;
  """.trimIndent()
    ...
    invoke-static Ljava/util/Arrays;->asList([Ljava/lang/String;)Ljava/util/List;
      =>
    invoke-static Lcom/hmx/ide/desugaring/sample/java/util/DesugaredArrays;->asList([Ljava/lang/String;)Ljava/util/List;
      ;;
  """.trimIndent()
  ...
  fun `test primitive arrays as method parameters`() {
    ...
    invoke-static Ljava/lang/Math;->max([I)I
      =>
    invoke-static Lcom/hmx/ide/desugaring/sample/java/lang/DesugaredMath;->max([I)I
      ;;
  """.trimIndent()
    ...
    invoke-virtual Ljava/lang/String;->toCharArray()[C
      =>
    invoke-static Lcom/hmx/ide/desugaring/sample/java/lang/DesugaredString;->toCharArray(Ljava/lang/String;)[C
      ;;
  """.trimIndent()
  ...
  fun `test simple instruction parse`() {
    val insnStr = """
      invoke-virtual Ljava/io/InputStream;->readNBytes(I)[B
        =>
      invoke-static Lcom/hmx/ide/desugaring/sample/java/io/DesugaredInputStream;->readNBytes(Ljava/io/InputStream;I)V
        ;;
    """.trimIndent()
    ...
    assertThat(insn.toClass).isEqualTo(
      "com.hmx.ide.desugaring.sample.java.io.DesugaredInputStream")
  ...
  fun `test parsing multiple instructions`() {
    ...
    invoke-static Ljava/lang/Math;->random()D
      =>
    invoke-static Lcom/hmx/ide/desugaring/sample/java/util/DesugaredMath;->random()D
      ;;
  """.trimIndent()
    ...
    insns[1].also { insn ->
      ...
      assertThat(insn.toOpcode).isEqualTo(MethodOpcode.INVOKESTATIC)
      assertThat(insn.toClass).isEqualTo(
        "com.hmx.ide.desugaring.sample.java.util.DesugaredMath")
